...
# -----------------------------
# Buttons (close/arrow/back/reset) are deliberately left out of this so
# they keep receiving normal clicks instead of starting a drag.
...
header_title.bind("<Button-1>", start_drag)
header_title.bind("<B1-Motion>", drag_window)
